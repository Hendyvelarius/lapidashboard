  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const cachedData = loadLinePN1Cache();
      ...
      <div className="line-pn1-main-content">
        <div className="line-pn1-content">
          ...
          <div className={`line-pn1-charts-container ${sidebarMinimized ? 'sidebar-minimized' : ''}`}>
            ...
            <div ref={outputRef} className="line-pn1-chart-card">
            ...
            {/* Daily OF1 */}
            <div ref={of1Ref} className="line-pn1-chart-card">
            ...
            {sidebarMinimized && (
              <div ref={wipSummaryRef} className="line-pn1-chart-card">
                <div className="chart-card-header">
                  <h3>WIP Summary</h3>
          ...
          <div ref={wipSectionRef} className="line-pn1-wip-section">
            {wipStages.length === 0 ? (
              <div style={{
                textAlign: 'center',
                padding: '60px 20px',
