...
const dashboardCards = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "material", label: "Quality Control", desc: "Monitoring QC material (BB/BK) dan produk jadi: inspeksi, leadtime, dan release.", icon: <FaClipboardList size={20} color="#e57373" />, route: "/quality-control", pageName: "quality-control" },
    ],
  },
  {
    Icon: FaArchive,
